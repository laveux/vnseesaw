...
- (void)scrollWheel: (GSEventRef)theEvent amount: (float)deltaY
{

//emm10:  Need to add a timer here to queue the scroll events (I think)
//emm10:  This works but it seems to drop most of the scroll events while the screen refreshes
...
//	for (int ii=0;ii < (int)abs(deltaY);ii++) {
