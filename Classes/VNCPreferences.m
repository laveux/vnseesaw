...
NSString * kUseTiltScrollPrefKey = @"UseTiltScroll";
...
//! This preference controls whether tilt scrolling is used.
- (BOOL)useTiltScroll {
	return [[NSUserDefaults standardUserDefaults] boolForKey:kUseTiltScrollPrefKey];
}
...
- (void)setShowScrollingIcon:(BOOL)showIcon {
	[[NSUserDefaults standardUserDefaults] setBool:showIcon forKey:kShowScrollingIconPrefKey];
}

- (void)setShowZoomPercent:(BOOL)showPercent {
	[[NSUserDefaults standardUserDefaults] setBool:showPercent forKey:kShowZoomPercentPrefKey];
}

- (void)setUseTiltScroll:(BOOL)useTiltScroll {
	[[NSUserDefaults standardUserDefaults] setBool:useTiltScroll forKey:kUseTiltScrollPrefKey];
}
