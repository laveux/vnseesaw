...
//		CGColorRef rgbTransparent = CGColorCreate(rgbSpace, kTransparentComponents);
		...
		[_aboutButton addTarget:self action: @selector(showAbout:) forEvents:1 /*kGSEventTypeButtonSelected*/];
		...
		[_preferencesButton addTarget:self action: @selector(showPreferences:) forEvents: 1/*kGSEventTypeButtonSelected*/];
