#if !defined(_VNSeeSawApp_h_)
#define _VNSeeSawApp_h_
 ...
 */
@interface VNSeeSawApp : UIApplication
{
	//! @name Views
	//@{
	UIWindow*			_window;
	...
	int					_editingIndex, 
						_serverConnectingIndex;	//!< Index of the server currently being edited.
