...
#define kRightArrowKeyCode		0xff53
#define kLeftArrowKeyCode		0xff51
#define kUpArrowKeyCode			0xff52
#define kDownArrowKeyCode		0xff54
#define kPageUpKeyCode			0xff55
#define kPageDownKeyCode		0xff56
#define kHomeKeyCode			0xff50
#define kEndKeyCode				0xff57
...
- (void)sendPageUpKey
{
	[self sendKey: kPageUpKeyCode  pressed:YES];
	[self sendKey: kPageUpKeyCode  pressed:NO];
}

- (void)sendPageDownKey
{
	[self sendKey: kPageDownKeyCode  pressed:YES];
	[self sendKey: kPageDownKeyCode  pressed:NO];
}

- (void)sendHomeKey
{
	[self sendKey: kHomeKeyCode  pressed:YES];
	[self sendKey: kHomeKeyCode  pressed:NO];
}

- (void)sendEndKey
{
	[self sendKey: kEndKeyCode  pressed:YES];
	[self sendKey: kEndKeyCode  pressed:NO];
}

- (void)sendRightArrowKey
{
	[self sendKey: kRightArrowKeyCode  pressed:YES];
	[self sendKey: kRightArrowKeyCode  pressed:NO];
}

- (void)sendLeftArrowKey
{
	[self sendKey: kLeftArrowKeyCode  pressed:YES];
	[self sendKey: kLeftArrowKeyCode  pressed:NO];
}

- (void)sendUpArrowKey
{
	[self sendKey: kUpArrowKeyCode  pressed:YES];
	[self sendKey: kUpArrowKeyCode  pressed:NO];
}

- (void)sendDownArrowKey
{
	NSLog(@"Send DownArrow");
	[self sendKey: kDownArrowKeyCode  pressed:YES];
	[self sendKey: kDownArrowKeyCode  pressed:NO];
}
